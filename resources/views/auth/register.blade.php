        ...
        <div class="container">
            <div class="card login-card">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6">
                        <img src="/auth/urbanui-login-template-free-2-38baaa875b8e/assets/images/reg.jpg" alt="login" class="login-card-img">
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            ...
                            <p class="login-card-description">Sign up an account</p>

                            <form method="POST" action="{{ route('register') }}">
                                @csrf
                                <div class="form-group">
                                    <label for="name" :value="__('name')" class="sr-only">Name</label>
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Username" :value="old('name')" required autofocus autocomplete="name">
                                    <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                </div>

                                <div class="form-group">
                                    <label for="email" :value="__('Email')" class="sr-only">Email</label>
                                    <input id="email" type="email" name="email" placeholder="Email" :value="old('email')" required autocomplete="username" class="form-control">
                                    <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                </div>

                                <div class="form-group mb-4">
                                    <label for="password" class="sr-only">Password</label>
                                    <input id="password" type="password" name="password" placeholder="Password" required autocomplete="new-password" class="form-control">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input id="password_confirmation" type="password" placeholder="Confirm password" name="password_confirmation" required autocomplete="new-password" class="form-control">
                                    <x-input-error :messages="$errors->get('password')" class="mt-2" />
                                </div>

                                <button type="submit" name="submit" id="register" class="btn btn-block login-btn mb-4" type="button" value="Login">Register</button>
                            </form>

 ...
 <div class="nav-header">
     <a href="{{ route('dashboards')}}" class="brand-logo">
         <div class="brand-wrapper">
             <img src="https://www.tic.go.tz/site/images/logo.png" alt="TIC logo" class="mx-auto img-fluid" style="width: 60px;">
         </div>
                 ...
                 <ul class="navbar-nav header-right">
                     ...
                     <li class="nav-item dropdown  header-profile">
                         <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                             <img src="{{ asset('admin/images/user.jpg') }}" width="56" alt="">
                         </a>

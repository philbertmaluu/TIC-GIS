                            ...
                            <div class="col-xl-12">
                                <div class="map-container">
                                    ...
                                    <div id="legend" class="legend">
                                        <div class="legend-item"><span style="background-color: #3366ff;"></span> Light Rainfall</div>
                                        <div class="legend-item"><span style="background-color: #33cc33;"></span> Moderate Rainfall</div>
                                        <div class="legend-item"><span style="background-color: #ff9933;"></span> Heavy Rainfall</div>
                                    </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <img src="{{ asset('admin/images/dash/temp.jpg') }}" style="width: 750px;" alt="">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var rainLayer = new ol.layer.Tile({
                source: new ol.source.XYZ({
                    url: 'https://tile.openweathermap.org/map/precipitation_new/{z}/{x}/{y}.png?appid=efaed6cf43966a6c0fe72cc946a31f89',
                    attributions: 'Rainfall data &copy; <a href="https://www.openweathermap.org">OpenWeatherMap</a>',
                    maxZoom: 18
                })
            });
